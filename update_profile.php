...
if (isset($_POST['update_profile'])) {
   ...
   mysqli_query($conn, "UPDATE `users` SET first_name = '$update_name', email = '$update_email' WHERE id = '$user_id'") or die('query failed');
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            <div class="inputBox">
               ...
               <span>Last Name :</span>
               <input type="text" name="update_name" value="<?php echo $fetch['last_name']; ?>" class="box">
            ...
            <div class="inputBox">
               ...
               <input type="date" name="old_pass" value="<?php echo $fetch['birthday']; ?>">
