...
<head>
	...
	<script defer src="./script/script_regester.js"></script>
</head>
	...
	<div class="wrapper" style="background-image: url('images/bg-registration-form-1.jpg');">
		<div class="inner">
			...
			<form action="" id="form" method="post" enctype="multipart/form-data">
				...
				<div class="error_name"></div><br>
				<div class="form-group">
					<input id="first_name" type="text" name="first_name" placeholder="First Name " class="form-control" required> <br>					
				...
				<div class="form-wrapper">
					<input type="password" id="pswrd_1" name="password" placeholder="enter password" class="fields form-control" required>
					
					<i class="zmdi zmdi-lock"></i>
				</div>
				<div class="form-wrapper">
					<input type="password" id="pswrd_2" name="cpassword" placeholder="confirm password" class="fields form-control" required>
